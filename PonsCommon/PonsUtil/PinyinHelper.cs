    ...
    public class PinyinHelper
    {
        ...
        private static string[] otherChinese = new string[]   
         {   
             ...
             ,"黟","黢","黩","黧","黥","黪","黯","鼢","鼬","鼯","鼹","鼷","鼽","鼾","齄","漷"
             ,"髙","恵","滘","徳","塱","湴","漖","浐","璟","巿","昇","俶","洑","甪","劵"
             ,"玥","蠡","溇","囯","埗","邨","坣","増","淸","庒","靑","釆","渏","澥","埌","孖"
             ,"尙","灜","珅","壆","梇","輋","鳯","锠","顔","潽","澐","猄","楡","橧","槎"
         };
        ...
        private static string[] otherPinYin = new string[]   
            {                            
                "Chu","Ji","Wu","Gai","Nian","Sa","Pi","Gen","Cheng","Ge","Nao","E","Shu","Yu","Pie","Bi",   
                 ...
                 "Xia","Yi","Qu","Du","Li","Qing","Can","An","Fen","You","Wu","Yan","Xi","Qiu","Han","Zha","Huo",
                 "Gao","Hui", "Jiao", "De","Lang","Ban","Jiao","Chan","Jing", "Shi","Sheng","Chu","Fu","Lu", "Quan",
                 "Yue","Li","Lou","Guo","Bu","Cun","Tang", "Zeng","Qing","Zhuang", "Qing","Cai","Yi","Xie","Lang","Ma",
                 "Shang","Ying","Kun","Xue","Long","She","Feng","Chang","Yan","Pu","Yun","Jing","Yu","Zeng","Cha"
            };
        #endregion 二级汉字
        /// <summary> 
        /// 汉字转换 
        ...
        public static string Convert(string hzString, int maxLength)
        {
            ...
            if (maxLength <= 1)
                maxLength = 10;
            hzString = GetInitalString(hzString);
            ...
            for (int j = 0; j < noWChar.Length; j++)
            {
                ...
                {
                    if (otherChinese.Contains(noWChar[j].ToString()))
                    {
                        pyString += otherPinYin[Array.IndexOf(otherChinese, noWChar[j].ToString())];
                        continue;
                    }
        ...
        public static string GetInitalString(string hzString)
        {
